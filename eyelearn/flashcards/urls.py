...
urlpatterns = [
    ...
    path('exams/<int:exam_id>/status/', exam_status, name='exam_status'),
    path('exams/<int:exam_id>/answer/', exam_answer, name='exam_answer'),
    path('exams/<int:exam_id>/finish/', exam_finish, name='exam_finish'),
